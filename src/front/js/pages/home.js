        ...
        <>
            ...
            <main className="main">
                        ...
                        <div className="swiper-wrapper">
                                ...
                                <div className="home__content grid">
                                    ...
                                    <div className="home__data">
                                        ...
                                        <div className="home__buttons">
                                            <Link to="/signup" className="button button--ghost">CODEA AHORA</Link>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="swiper-slide">
                                <div className="home__content grid">
                                    ...
                                    <div className="home__data">
                                        ...
                                        <div className="home__buttons">
                                            <Link to="/login" className="button button--ghost">INICIA SESIÓN Y COMPARTE</Link>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="swiper-slide">
                                <div className="home__content grid">
                                    ...
                                    <div className="home__data">
                                        <h3 className="home__subtitle">Sé parte del Top Mundial...</h3>
                                        ...
                                        <div className="home__buttons">
                                            <Link to="/challenges" className="button button--ghost">RANKEA AHORA</Link>
                                        </div>
                                    </div>
                                </div>
                            </section>
                ...
                <section className="section category" id="trick">
                    <h2 className="section__title">Retos <br /> Espeluznantes <br /> Para todos los niveles</h2>
                ...
                <section className="section about" id="treat">
                    <div className="about__container container grid">
                        <div className="about__data">
                            ...
                            <div className="home__buttons">
                                <Link to="/signup" className="button button--ghost">APRENDE AHORA</Link>
                            </div>
                        </div>
